...
/**
 * La classe DistanceConverterApplication illustre le fonctionnement d'une {@link Application} JavaFX.
 *
 * @author Romain Wallon
 *
 * @version 0.1.0
 */
public class DistanceConverterApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("distance-converter.fxml"));
        ...
        stage.setTitle("Convertisseur de distance");
